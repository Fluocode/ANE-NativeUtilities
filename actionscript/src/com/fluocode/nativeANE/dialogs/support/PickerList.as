/**
 * One column of labels for <code>NativePickerDialog</code>.
 *
 * @see com.fluocode.nativeANE.dialogs.NativePickerDialog
 */
package com.fluocode.nativeANE.dialogs.support
{
	...
	/**
	 * Describes a single wheel column: data provider, labels, selection, and optional width.
	 *
	 * @playerversion AIR 3
	 */
	public class PickerList extends EventDispatcher
	{
		...
		/**
		 * @param dataProvider Items for this column (array, vector, or <code>IList</code>-like with <code>length</code>)
		 * @param selectedIndex Initial selected index, or <code>-1</code> for none
		 */
		...
		/**
		 * The parent <code>NativePickerDialog</code> while this column is attached, or <code>null</code>.
		 *
		 * <p><b>Note:</b> The accessor name <code>dialgo</code> is a historical typo; it returns the dialog reference.</p>
		 */
		...
		/**
		 * Builds the visible label list for this column using <code>labelFunction</code>, <code>labelField</code>, or <code>String(item)</code>.
		 *
		 * @return Vector of label strings, or <code>null</code> if there is no data provider
		 */
