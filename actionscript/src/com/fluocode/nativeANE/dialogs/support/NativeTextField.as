/**
 * Descriptor for a single row in <code>NativeTextInputDialog</code> (editable field or static label on iOS).
 *
 * @see com.fluocode.nativeANE.dialogs.NativeTextInputDialog
 */
package com.fluocode.nativeANE.dialogs.support
{
	...
	/**
	 * Configuration for one text row in a native text-input dialog (keyboard hints, password mode, etc.).
	 *
	 * @playerversion AIR 3
	 */
	public class NativeTextField extends EventDispatcher
	{
		...
		/**
		 * Parent <code>NativeTextInputDialog</code> when this field is registered, or <code>null</code>.
		 */
		...
		/**
		 * @param name Unique field name used to correlate native events with this instance
		 */
