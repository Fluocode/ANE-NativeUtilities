/**
 * Native wheel-style picker dialog with one or more <code>PickerList</code> columns (iOS and Android).
 *
 * @see com.fluocode.nativeANE.dialogs.support.PickerList
 */
package com.fluocode.nativeANE.dialogs
{
	...
	/**
	 * Multi-column native picker dialog. Supply a vector of <code>PickerList</code> instances as <code>dataProvider</code>,
	 * then call <code>show()</code>.
	 *
	 * @playerversion AIR 3
	 */
	public class NativePickerDialog extends AbstractNativeDialog
	{
		 ...
		 *
		 * @param theme Android/iOS theme constant; <code>-1</code> uses <code>defaultTheme</code>
		 */
		...
		/**
		 * Updates the native wheel selection for a column (invoked from <code>PickerList</code> when the dialog is visible).
		 *
		 * @param pickerList Column whose selection should change
		...
		/**
		 * Sets the picker columns. Each entry is a <code>PickerList</code>.
		 *
		 * @param value Vector of picker columns (must not be empty when calling <code>show()</code>)
		 */
		...
		/**
		 * Column definitions for this picker, or <code>null</code> until set.
		 */
		...
		/**
		 * Releases native resources and clears <code>PickerList</code> back-references.
		 */
