/**
 * Native list and multi-choice dialogs (Android and iOS).
 *
...
package com.fluocode.nativeANE.dialogs
{
	...
	/**
	 * Presents a scrollable list with single- or multi-select behavior. Set <code>dataProvider</code>,
	 * optional <code>labelField</code> / <code>labelFunction</code>, then call <code>show()</code>.
	 *
	 * @see http://fluocode.com/
	 * @since 2013
	 * @playerversion AIR 3
	...
	public class NativeListDialog extends AbstractNativeDialog
	{
		...
		/**
		 * @param androidTheme Theme constant for Android; <code>-1</code> uses <code>defaultAndroidTheme</code>
		 * @param iOSTheme     Theme constant for iOS; <code>-1</code> uses <code>defaultIOSTheme</code>
		 *
		 * @since 2013
		 *
		 * @event flash.events.ErrorEvent
		 * @event com.fluocode.nativeANE.events.NativeDialogEvent
		 * @event com.fluocode.nativeANE.events.NativeDialogListEvent
		 */
