/**
 * Native progress and indeterminate spinner dialogs (Android and iOS).
 *
...
package com.fluocode.nativeANE.dialogs
{
	...
	public class NativeProgressDialog extends AbstractNativeDialog
	{
		...
		//---------------------------------------------------------------------
		/**
		 * Horizontal determinate progress bar style.
		 */
		public static const STYLE_HORIZONTAL:uint = 1;
		/**
		 * Circular spinner (indeterminate) style.
		 */
		public static const STYLE_SPINNER:uint = 0;
		
		
		/** Android Material/device default dark theme for the progress dialog. */
		public static const ANDROID_DEVICE_DEFAULT_DARK_THEME:uint = 4;
		/** Android Material/device default light theme for the progress dialog. */
		...
		//---------------------------------------------------------------------
		/**
		 * Creates a progress dialog wrapper.
		 *
		 * @param androidTheme Android theme id; <code>-1</code> uses <code>defaultAndroidTheme</code>
		 * @param iOSTheme     iOS theme id; <code>-1</code> uses <code>defaultIOSTheme</code>
		 *
		 * @throws Error if the extension context cannot be created
		 *
		 * @since 2011
		 * @playerversion AIR 3
		 */
