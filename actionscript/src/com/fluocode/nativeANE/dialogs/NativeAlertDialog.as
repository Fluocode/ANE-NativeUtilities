/**
 * Native alert dialog with title, message, and customizable buttons (iOS and Android).
 *
...
package com.fluocode.nativeANE.dialogs
{
	...
	/**
	 * Device-native alert with title, message, and one or more buttons. Listen for
	 * <code>NativeDialogEvent.OPENED</code> and <code>NativeDialogEvent.CLOSED</code> to track lifecycle;
	 * the closed event carries the button index in <code>index</code>.
	 *
	 * @see http://fluocode.com/
	 * @since 2011
	 * @playerversion AIR 3
