/**
 * Native date, time, or date-time picker dialog.
 *
...
package com.fluocode.nativeANE.dialogs
{
	...
	/**
	 * Wraps platform date/time pickers. Set <code>displayMode</code>, <code>date</code>, optional <code>minDate</code>/<code>maxDate</code>, then <code>show()</code>.
	 *
	 * @see http://fluocode.com/
	 * @since 2013
	 * @playerversion AIR 3
	...
	public class NativeDatePickerDialog extends AbstractNativeDialog
	{
		...
		/**
		 * Maximum selectable date passed to native pickers when both min and max are set.
		 *
		 * @param date Upper bound, or <code>null</code> for no maximum
		 */
		...
		/**
		 * Minimum selectable date passed to native pickers when both min and max are set.
		 *
		 * @param date Lower bound, or <code>null</code> for no minimum
		 */
