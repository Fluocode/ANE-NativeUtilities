/**
 * Native dialog with one or more text fields (Android and iOS).
 *
...
package com.fluocode.nativeANE.dialogs
{
	...
	/**
	 * Native alert-style dialog containing <code>NativeTextField</code> rows for labels and inputs.
	 *
			...
			if(_cancelable!==value){
				...
				if(_isShowing){
					try{
						...
						/*if(isIOS){
						context.call("setCancelable",value);
						return true;
						}*/
					}catch(e:Error){
