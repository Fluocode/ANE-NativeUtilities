...
public class NativeDialogsExtension implements FREExtension 
{
	...
	/** Dispatched when system UI visibility changes (e.g. status/nav bar shown or hidden). Event level is the visibility flags int as string. */
	public static final String UI_VISIBILITY_CHANGE = "UIVisibilityChange";
	...
	/**
	 * Called when the extension is loaded. Logs initialization; no extra setup is required.
	 */
